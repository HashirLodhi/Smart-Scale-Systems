...
- Use named Markdown links with these relative routes: [Services](/services), [Team](/team), [Contact Us](/contact), [Careers](/careers), [Testimonials](/testimonials), [Privacy Policy](/privacy-policy), and [Terms of Service](/terms-of-service).
...
function buildFallbackReply(message, historyText) {
  ...
  if (/\b(fuck you|fuck off|idiot|stupid bot|useless)\b/.test(lower)) {
    return 'I am still here to help. Ask me about Smart Scale Systems services, the team, pricing, careers, or how to start a project.';
  }
  ...
  if (/\b(job|jobs|career|careers|hiring|apply|vacancy|role)\b/.test(lower)) {
    return 'Smart Scale Systems currently lists **no open roles**. You can check [Careers](/careers) for updates or send your CV for future opportunities.';
  }
  ...
  if (!matches.length) {
    return 'I can help with Smart Scale Systems services, team, project fit, pricing process, careers, privacy, and how to get started. Try asking what service fits your use case, or explore [Services](/services).';
  }
