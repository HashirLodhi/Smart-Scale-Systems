...
const favicon = fs.readFileSync(path.join(root, 'public', 'logo-main.png'));
...
const expectedTitles = [
  'Smart Scale Systems | AI Agency in Pakistan',
  'Services | AI Services in Pakistan',
  'Our Team | AI Experts in Pakistan',
  'Careers | AI Jobs in Pakistan',
  ...
  'AI Agency in Pakistan | AI Development Company',
  'AI Services in Pakistan | Automation, Models and Data',
...
check(
  html.includes('<title>Smart Scale Systems | AI Agency in Pakistan</title>'),
  'home tab starts with Smart Scale Systems'
);
check(
  (html.match(/href="\/logo-main\.png\?v=20260726-real-logo"/g) || []).length === 3,
  'favicon links use the cache-busted real company logo'
);
check(
...
console.log(`SEO and favicon behavior passed 6 checks across ${expectedTitles.length} route titles.`);
