...
const SITE = 'https://smartscalesystems.com';
...
const sections = [
    ...
    blocks: [
      {
        ...
        paragraphs: [
          ...
          'The agency serves businesses in Pakistan and international clients. Its website positions the team as delivery-focused: useful production systems, reliable data, measurable performance, and clear communication rather than experiments that never ship.',
        ],
      },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        heading: 'Does the agency only serve Pakistan?',
        paragraphs: [
          'No. Smart Scale Systems presents itself as an AI agency in Pakistan serving Pakistani and international clients.',
        ],
      },
      {
    ...
    blocks: [
      ...
      },
      {
        ...
        bullets: [
          ...
          `AI Services in Pakistan - ${SITE}/ai-services-pakistan`,
          `AI Agency in Pakistan - ${SITE}/ai-agency-pakistan`,
        ],
      },
      {
        heading: 'Legal pages',
